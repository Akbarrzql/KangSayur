...
//
//     final statusPesananDisiapkan = statusPesananDisiapkanFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

StatusPesananDisiapkan statusPesananDisiapkanFromJson(String str) => StatusPesananDisiapkan.fromJson(json.decode(str));

String statusPesananDisiapkanToJson(StatusPesananDisiapkan data) => json.encode(data.toJson());

class StatusPesananDisiapkan {
  String status;
  String message;
  List<Datum> data;

  StatusPesananDisiapkan({
    required this.status,
    required this.message,
    required this.data,
  });

  factory StatusPesananDisiapkan.fromJson(Map<String, dynamic> json) => StatusPesananDisiapkan(
    status: json["status"],

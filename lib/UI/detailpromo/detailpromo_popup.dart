...
import '../detail/checkoutbuy/checkoutbuy.dart';
import '../detail/detail_content.dart';

class DetailPromoPopup extends StatefulWidget {
  DetailPromoPopup(
      {Key? key,
  ...
  @override
  State<DetailPromoPopup> createState() => _DetailPromoPopupState();
}

class _DetailPromoPopupState extends State<DetailPromoPopup> {
                              ...
                              Text(
                                "Rp. " +
                                    NumberFormat("#,###,##0", "id_ID")
                                        .format(widget.hargaVariant[0]) +
                                    ",00",                                style: const TextStyle(
                                    fontSize: 20,

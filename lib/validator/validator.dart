class InputValidator {
  ...
  static String? phoneValidator(value) {
    return value.toString().length <= 10 || value.toString().length >= 13
  ...
  static String? nameTokoValidator(value) {
    return value.toString().length <= 3 ? 'Nama Toko tidak valid' : null;
  }

  static String? descTokovalidator(value) {
    return value.toString().length <= 3 ? 'Deksripsi Toko tidak valid' : null;
  }

  static String? addressValidator(value) {
    return value.toString().length <= 3 ? 'Alamat tidak valid' : null;
  }

  static String? vehicleValidator(value) {
    return value.toString().length <= 3 ? 'Jenis Kendaraan tidak valid' : null;
  }

  static String? licenseValidator(value) {
    return value.toString().length <= 3 ? 'Nomor Polisi tidak valid' : null;
  }

  static String? noRangkaValidator(value) {
    return value.toString().length <= 3 ? 'Nomor Rangka tidak valid' : null;
  }
}
